...
CLASS_INDEX = None
CLASS_INDEX_PATH = 'E:\\StudyMaterial\\hackathon2016\\imagenet_class_index.json'
...
def decode_predictions(preds):
    ...
    top_pred['label'] = CLASS_INDEX[str(top_index[0])]    
    top_pred['prob'] = preds[0][top_index]
    ...
    preds_dict = { idx: prob for idx,prob in enumerate(preds[0])}
    out_label_probs = []
